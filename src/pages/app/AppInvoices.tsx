...
import { FileText, TrendingUp, TrendingDown, DollarSign, Plus, Download, Search } from "lucide-react";
              ...
              <TableBody>
                {filtered.map((inv: any) => (
                  <TableRow key={inv.id}>
                    ...
                    <TableCell className="text-right font-mono">
                      €{Number(inv.amount_vat).toLocaleString("es-ES", { minimumFractionDigits: 2 })}
                    </TableCell>
                    ...
                    <TableCell className="text-right">
                      <Button variant="ghost" size="sm" onClick={() => handleExportPdf(inv.id)}>

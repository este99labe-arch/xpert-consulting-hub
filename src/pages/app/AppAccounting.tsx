  ...
  const seedChart = useMutation({
    mutationFn: async () => {
      const defaultAccounts = [
        ...
        { code: "473", name: "H.P. retenciones y pagos a cuenta", type: "ASSET" },
        { code: "4700", name: "H.P. deudora por IVA", type: "ASSET" },
        { code: "4750", name: "H.P. acreedora por IVA", type: "LIABILITY" },
        { code: "4751", name: "H.P. acreedora por retenciones practicadas", type: "LIABILITY" },

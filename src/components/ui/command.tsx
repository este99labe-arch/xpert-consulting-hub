...
interface CommandDialogProps extends DialogProps {
  /** Pasa a cmdk. En un buscador asíncrono hay que ponerlo a false: los
   *  resultados ya vienen filtrados del servidor y el filtro de cliente
   *  vuelve a cribarlos contra el texto visible, escondiendo aciertos. */
